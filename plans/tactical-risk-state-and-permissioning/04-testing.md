...
- `plans/tactical-risk-state-and-permissioning/testing-report.md`
...
- Record any implementation-specific command renames in `plans/tactical-risk-state-and-permissioning/testing-report.md` after feature implementation.
