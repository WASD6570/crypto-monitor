...
func TestParseTradeEventFeedsCanonicalNormalization(t *testing.T) {
	fixture := loadTradeFixture(t, "tests/fixtures/events/kraken/ETH-USD/happy-trade-usd.fixture.v1.json")
	...
	if !event.CanonicalEventTime.Equal(time.Date(2026, time.March, 6, 12, 0, 1, 0, time.UTC)) {
